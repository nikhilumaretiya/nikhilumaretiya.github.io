...
export default function ResumeClient() {
    ...
    return (
        <article className="resume active px-4 md:px-8 max-w-7xl mx-auto" data-page="resume">
            <header>
                <h1 className="text-[34px] md:text-[48px] lg:text-[64px] font-bold tracking-tighter mb-8 leading-none">Resume</h1>
            </header>

            <section className="mb-14">
                <div className="flex items-center gap-4 mb-8">
                    <div className="bg-bg-gradient-jet p-3 rounded-xl shadow-1 border border-white/5 text-accent-color">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811V2.828zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" /></svg>
                    </div>
                    <h2 className="text-2xl font-semibold text-white-2">Experience</h2>
                </div>
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="relative mb-10 last:mb-0">
                        ...
                        <h3 className="text-lg font-bold text-white-2 mb-1">Professional Freelancer</h3>
                    ...
                    <motion.div variants={itemVariants} className="relative mb-10 last:mb-0">
                        ...
                        <h3 className="text-lg font-bold text-white-2 mb-1">PHP Web Developer</h3>
                    ...
                    <motion.div variants={itemVariants} className="relative mb-10 last:mb-0">
                        <span className="absolute -left-[37px] md:-left-[45px] top-2 w-4 h-4 rounded-full bg-bg-gradient-jet border-2 border-white/20 z-10 hover:border-accent-color transition-colors duration-300" />
                        <h3 className="text-lg font-bold text-white-2 mb-1">Trainee Developer</h3>
            ...
            <section className="mb-8">
                <div className="flex items-center gap-4 mb-8">
                    <h2 className="text-2xl font-semibold text-white-2 flex-grow">My Skills</h2>
                        ...
                        {[
                            ...
                            <li key={index}>
                                <div className="flex justify-between items-center mb-2">
                                    <h4 className="text-sm font-medium text-white-2">{skill.name}</h4>
                                    <data className="text-sm font-light text-light-gray" value={parseInt(skill.val)}>{skill.val}</data>
                                </div>
                                <div className="h-2 w-full bg-eerie-black-2 rounded-full overflow-hidden">
                                    <motion.div
                                        role="progressbar"
                                        aria-valuenow={parseInt(skill.val)}
                                        aria-valuemin={0}
                                        aria-valuemax={100}
